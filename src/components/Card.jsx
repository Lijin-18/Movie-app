...
function Card({image , movieName , rating , id}) {
  ...
  return (
    <div onClick={displayMovieDetail} className='cursor-pointer w-40 sm:w-60 bg-white rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition duration-300 mt-5'>
